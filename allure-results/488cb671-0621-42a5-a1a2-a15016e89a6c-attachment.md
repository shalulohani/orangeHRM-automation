...
- Name: tests\applyLeave.spec.ts >> Apply for leave
- Location: tests\applyLeave.spec.ts:6:5

# Error details

```
TypeError: leave.navigateToApplyLeave is not a function
```
          ...
          - generic [ref=e258]:
            - generic [ref=e259] [cursor=pointer]:
              ...
              - generic [ref=e262]:
                ...
                - paragraph [ref=e264]: 2026-07-06 07:15 PM
            - separator [ref=e265]
            - paragraph [ref=e266]: This is a valid multi-line comment with normal content.
          - generic [ref=e267]:
            - generic [ref=e268] [cursor=pointer]:
              - img "profile picture" [ref=e270]
              - generic [ref=e271]:
                - paragraph [ref=e272]: manda akhil user
                - paragraph [ref=e273]: 2026-07-06 07:14 PM
            - separator [ref=e274]
            - paragraph [ref=e275]: This is a valid multi-line comment with normal content.
          - generic [ref=e276]:
            - generic [ref=e277] [cursor=pointer]:
              - img "profile picture" [ref=e279]
              - generic [ref=e280]:
                - paragraph [ref=e281]: manda akhil user
                - paragraph [ref=e282]: 2026-07-06 07:14 PM
            - separator [ref=e283]
            - paragraph [ref=e284]: "' OR '1'='1"
          - generic [ref=e285]:
            - generic [ref=e286] [cursor=pointer]:
              - img "profile picture" [ref=e288]
              - generic [ref=e289]:
                - paragraph [ref=e290]: manda akhil user
                - paragraph [ref=e291]: 2026-07-06 07:14 PM
            - separator [ref=e292]
            - paragraph [ref=e293]: <script>alert('xss')</script>
          - generic [ref=e294]:
            - generic [ref=e295] [cursor=pointer]:
              - img "profile picture" [ref=e297]
              - generic [ref=e298]:
                - paragraph [ref=e299]: manda akhil user
                - paragraph [ref=e300]: 2026-07-06 06:42 PM
            - separator [ref=e301]
            - paragraph [ref=e302]: This is a valid multi-line comment with normal content.
      - generic [ref=e304]:
        - generic [ref=e305]:
      ...
      - generic [ref=e318]:
        ...
        - list [ref=e328]:
          ...
          - listitem [ref=e335] [cursor=pointer]:
            - generic "Client Services" [ref=e337]
...
```ts
  ...
  3  | import { ApplyLeavePage } from '../pages/ApplyLeavePage';
  4  | import { logStep, logSuccess } from '../utils/logger';
  5  | 
  6  | test('Apply for leave', async ({ page }) => {
  7  | 
  8  |   const leave = new ApplyLeavePage(page);
  9  | 
  10 |   logStep('Navigating to Apply Leave page');
> 11 |   await leave.navigateToApplyLeave();
     |               ^ TypeError: leave.navigateToApplyLeave is not a function
  12 | 
  13 |   logStep('Selecting leave type and date');
  14 |   await leave.selectLeaveType('Annual Leave');
  15 |   await leave.selectFromDate('2024-06-10');
  16 |   await leave.selectToDate('2024-06-10');
  17 | 
  18 |   logStep('Submitting leave request');
  19 |   await leave.submitLeave();
  20 | 
  21 |   logStep('Verifying leave submission');
  22 |   await leave.verifySuccess();
  23 | 
  24 |   logSuccess('Leave applied successfully');
  25 | });
  26 | 
```